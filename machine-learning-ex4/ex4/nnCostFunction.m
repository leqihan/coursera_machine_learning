...
for i = 1:m
    ...
    delta3 = a3i' - yi;
    delta2 = (Theta2(:, 2:end)' * delta3) .* sigmoidGradient(z2i');
    
    Theta2_grad = Theta2_grad + delta3 * [1, a2i];
    Theta1_grad = Theta1_grad + delta2 * [1, a1i];
    
    J = J + 1/m * (-yi' * log(a3i') - (1 - yi)' * log(1 - a3i'));
end;
...
J = J + reg * lambda / (2 * m); % Add regularization term to cost function
